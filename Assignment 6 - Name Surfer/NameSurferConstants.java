...
/** The number of pixels to reserve for decade numbering*/
	public static final int SMALL_MARGIN = 3;
	
/** The name of file which stores all the names */
	public static final String NAMES_FILE = "names-data.txt";
